...
namespace HUX.Interaction
{
    public class InteractionManager : Singleton<InteractionManager>
    {
        ...
        private void InteractionManager_SourcePressedCallback(UnityEngine.XR.WSA.Input.InteractionSourcePressedEventArgs e)
        {
            var state = e.state;
            AFocuser focuser = GetFocuserForSource(state.source.kind);
            OnPressedEvent(focuser);
        }
        private void InteractionManager_SourceReleasedCallback(UnityEngine.XR.WSA.Input.InteractionSourceReleasedEventArgs e)
        {
            var state = e.state;
            AFocuser focuser = GetFocuserForSource(state.source.kind);
            OnReleasedEvent(focuser);

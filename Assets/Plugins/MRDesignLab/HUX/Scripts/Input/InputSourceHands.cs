...
public class InputSourceHands : InputSourceBase, ITargetingInputSource
{
    ...
    */
    ...
    public void WSASourceEntered(UnityEngine.XR.WSA.Input.InteractionSourceDetectedEventArgs e)
    {
        var state = e.state;
        // Track Hands
        if (state.source.kind == UnityEngine.XR.WSA.Input.InteractionSourceKind.Hand)
    ...
    public void WSASourceUpdate(UnityEngine.XR.WSA.Input.InteractionSourceUpdatedEventArgs e)
    {
        var state = e.state;
        if (state.source.kind == UnityEngine.XR.WSA.Input.InteractionSourceKind.Hand)
        {
    ...
    public void WSASourceLost(UnityEngine.XR.WSA.Input.InteractionSourceLostEventArgs e)
    {
        var state = e.state;
        if (state.source.kind == UnityEngine.XR.WSA.Input.InteractionSourceKind.Hand)
        {
    ...
    private void WSAFingerPressed(UnityEngine.XR.WSA.Input.InteractionSourcePressedEventArgs e)
    {
        var state = e.state;
        CurrentHandState inputState = trackedHands.Find(CurrentInputState => CurrentInputState.HandId == state.source.id);
        if (inputState != null)
    ...
    private void WSAFingerReleased(UnityEngine.XR.WSA.Input.InteractionSourceReleasedEventArgs e)
    {
        var state = e.state;
        CurrentHandState inputState = trackedHands.Find(CurrentInputState => CurrentInputState.HandId == state.source.id);
        if (inputState != null)
